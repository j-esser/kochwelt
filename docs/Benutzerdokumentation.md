...
8. [Datenhaltung & Datenschutz](#8-datenhaltung--datenschutz)
...
| Tab | Symbol | Funktion |
|-----|--------|---------|
| Home | Haus | Überblick, Wochenstatistik, Rezept des Tages |
| Rezepte | Buch | Alle Rezepte durchsuchen und verwalten |
| Planer | Kalender | Mahlzeiten für die Woche einplanen |
| Shopping | Einkaufswagen | Einkaufsliste aus dem Wochenplan |
| Einstellungen | Zahnrad | Benachrichtigungen, Nährwertziele |

---

## 2. Startseite

Die Startseite begrüßt dich je nach Tageszeit und gibt dir einen schnellen Überblick.

### Begrüßung
- Morgens (bis 11 Uhr): „Guten Morgen"
- Mittags (11–14 Uhr): „Guten Appetit"
- Nachmittags (14–18 Uhr): „Guten Nachmittag"
- Abends (ab 18 Uhr): „Guten Abend"

### Statistik-Karten

**Meine Rezepte** — Zeigt die Gesamtzahl aller gespeicherten Rezepte.

**Diese Woche** — Zeigt, wie viele Tage und Mahlzeiten du für die laufende Woche eingeplant hast. Der Fortschrittsbalken und ein Badge bewerten deine Planung:
- „Gute Planung": mindestens 2 Tage oder 4 Mahlzeiten eingeplant
- „Tolle Woche!": mindestens 6 Tage oder 10 Mahlzeiten eingeplant

### Rezept des Tages
Eine zufällig ausgewählte Featured Card zeigt dir täglich ein Rezept mit Foto, Kochzeit, Portionszahl und Kalorien. Tippe darauf, um das Rezept zu öffnen.

### Neueste Rezepte
Die ersten fünf Rezepte aus deiner Liste sind als horizontale Karten sichtbar — ideal für einen schnellen Zugriff.
...
Die Rezeptliste zeigt alle gespeicherten Rezepte alphabetisch sortiert.

#### Suche
Tippe in das Suchfeld oben, um Rezepte nach **Titel, Beschreibung, Zutaten oder Kategorie** zu filtern. Die Suche reagiert sofort auf jede Eingabe.

#### Kategorie-Tabs
Wähle einen Tab, um nur Rezepte der gewünschten Kategorie zu sehen:

> Alle · Pasta · Reis · Curry · Suppe · Fisch · Fleisch · Vegetarisch · Salat · Eintopf · Ohne Kategorie

#### Filterchips
Unterhalb der Tabs gibt es fünf zusätzliche Schnellfilter:

| Filter | Kriterium |
|--------|-----------|
| Schnell | Kochzeit ≤ 25 Minuten |
| Einfach | Höchstens 6 Zutaten und Kochzeit ≤ 30 Minuten |
| High-Protein | ≥ 25 g Eiweiß pro Portion |
| Low-Carb | < 20 g Kohlenhydrate pro Portion |
| Low-Kalorie | < 400 kcal pro Portion |

Mehrere Filter können gleichzeitig aktiviert sein.

#### Rezeptkarte
Jede Karte zeigt:
- Foto des Rezepts
- Titel
- Kochzeit und Portionszahl
- Kalorien pro Portion (orange hervorgehoben)
- Top-3-Zutaten als Teaser
- Kategorie-Badges
- Flammen-Badge, wenn das Rezept in den letzten 28 Tagen eingeplant war (z. B. „3× in 4 Wochen")

#### Neues Rezept erstellen
Tippe oben rechts auf das **+**-Symbol.

### 3.2 Rezept-Detailansicht

#### Foto
Das Rezeptfoto wird oben als breites Bild angezeigt. Fehlt ein Foto, wird ein Platzhalterbild gezeigt.

#### Kopfbereich
- **Titel** des Rezepts
- **Kochzeit** (in Minuten) als Chip
- **Portionsskalierung** — Tippe auf **−** oder **+**, um die Anzahl der Portionen anzupassen (1–20). Alle Zutatenmengen passen sich sofort live an.
- **Kategorie-Badges**
- **Koch-Zähler**: Zeigt „X× in 4 Wochen", wenn das Rezept im Planer eingesetzt wurde. Tippe darauf, um die genauen Daten zu sehen.
- **Sternebewertung**: Tippe auf die Sterne, um deine persönliche Bewertung (1–5) festzulegen oder zu ändern.
